...
func main() {
	...
	/* TODO:
	 * TODO: 1. Determine structure of data
	 * TODO: 2. Using available dvpgs named ci- gather all vlan ids and associate with
	 * TODO: IBM network vlans
	 * TODO: 3. Then create the resulting data
	 */

	_, err := generation.CreateVSphereEnvironmentsConfig()
	if err != nil {
		log.Fatal(err)
	}
